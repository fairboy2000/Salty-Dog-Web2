...
<body>
  ...
  <nav class="navbar navbar-expand-lg ">
            <div class="dropdown">
                ...
                <ul>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <li>
                            <a class="dropdown-item" href="../Pages/live.html" target="_blank">Live</a>
                        </li>
                        <li>
    ...
    <div class="container">
        <img src="images/SPECIALS.png" style="width:100%; height:auto" alt="Banner of Overhead drone shot of salty dog cafe in south beach, with salty dog logo and daily specials written on it.">
