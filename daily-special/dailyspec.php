...
<body>
  ...
  <nav class="navbar navbar-expand-lg ">
    ...
    <div class="container">
        <img src="images/SPECIALS.png" style="width:100%; height:auto" alt="Banner of Overhead drone shot of salty dog cafe in south beach, with salty dog logo and  written on it.">
