...
function loadFlickr(t){
		var dataUrl = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=c149b994c54c114bd7836b61539eec2e&tags=salty+dog+cafe+dog+photos+for+salty+dog+site&safe_search=1&format=json&page=' + pageCtr + '&extras=url_n';
		$.ajax({
			url:dataUrl
			,dataType: 'jsonp'
			,jsonp: 'jsoncallback' 
