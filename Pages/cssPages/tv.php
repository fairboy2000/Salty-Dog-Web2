	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<a href="http://saltydog.com"><img src="http://saltydog.com/images/home.png" alt="home" width="75" height="75"></a>
				<center><ul>
						<button><a class="active" href="index.html">LIVE</a></button>
						<button><a href="http://cal.saltydog.com">Schedule</a></button>
					  <button><a href="http://saltydog.com/livemusic">Artist Bios + Songlists</a></button>
						<button><a href="https://livestream.com/saltydog">Replays</a></button>
						<button><a href="http://music.saltydog.com/request/">Live Requests</a></button>
		</ul></center>
		...
		<div class="container">
			...
			<strong><font color="navy" size="5" face="avenir next">Broadcasting Live* From The Salty Dog Cafe</font></strong>
				  <br>
			      Hilton Head Island, SC 29928</p>
				  <strong><font size="+6" face="avenir next" color="navy"></font></strong>
...
<font size="3" color="navy" face="verdana">Salty Dog Livestream Broadcasts Will End November 4th, 2018.  
<br>See You Spring 2019.  Thanks For Listening.

<br><a href="https://livestream.com/saltydog">Please Select A Replay Above Featuring Dave K, Cory, Trevor or Dallas.</a></font>
<br>
...
<iframe id="ls_embed_1541071502" src="https://livestream.com/accounts/9128298/events/8437140/player?width=640&height=360&enableInfoAndActivity=true&defaultDrawer=&autoPlay=true&mute=false" width="640" height="360" frameborder="0" scrolling="no" allowfullscreen> </iframe><script type="text/javascript" data-embed_id="ls_embed_1541071502" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script>
...
<font size="3" color="navy" face="avenir next">*Salty Dog Live is multi-platform and streams on all devices including Apple, Windows, Android, Samsung Smart TV's, Roku, etc.</font></font> <div style="padding-top:10px;width:270px;margin:0 auto;">
